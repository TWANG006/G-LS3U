...
static inline long ELT(const int iNumCols, const int y, const int x)
{
...
static int ReadMatrixSizeFromStream(FILE * file, int * rows, int * cols)
{
...
static int WriteMatrixHeaderToStream(FILE * file, int rows, int cols)
{
